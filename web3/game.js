class Game{
    constructor(publicAddress = null){
        ...
        this.assetsPath = './web3/assets/';

        this.clock = new THREE.Clock();

        this.init();

        this.publicAddress = publicAddress; // Store the public address
        if (this.publicAddress) {
            console.log(`Connected Wallet Address: ${this.publicAddress}`);
        }
